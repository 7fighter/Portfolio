...
const Index = () => {
  ...
  const skills = [
    ...
    },
    {
      ...
      technologies: ['Node.js', 'Express', 'Next.js', 'MERN', 'RESTful APIs']
    },
    {
      category: 'Database_Systems',
      icon: Database,
      color: 'text-green-400',
      technologies: ['MongoDB', 'PostgreSQL', 'Convex', 'Supabase','SQl']
    },
    {
      category: 'Design_UX',
      icon: Palette,
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
          ...
          >
            ...
            <div className="relative z-10">
                ...
                <div className="space-y-4 text-muted-foreground text-lg leading-relaxed max-w-2xl">
                  <p>
                    I'm a <span className="text-white font-semibold">Full Stack</span>Architect specialized in the Next.js. I bridge the gap between heavy backend logic and buttery-smooth frontend motion.
                  </p>
                  <p className="text-base opacity-80">
                    My philosophy is rooted in UI & Performance. If a system is messy, it is fundamentally broken. I craft interfaces that don't just work—they feel alive.
                  </p>
                </div>
            </div>
          </motion.div>
          ...
          >
            ...
            <p className="text-sm font-bold leading-tight mt-12 relative z-10">
              Specializing in clean interfaces and complex global state management.
            </p>
          </motion.div>
        </div>
  ...
  >
    ...
    <ul className="space-y-8 relative z-10">
      {[
        { label: 'Experience', value: '1+ Years', width: 'w-[85%]' },
        { label: 'Deployments', value: '4+ Systems', width: 'w-[95%]' },
